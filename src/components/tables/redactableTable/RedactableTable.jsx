...
import { identificationFields, wellForm } from "../../../data/wellDataForm.js";
import { getCollectedData } from "../../../redux-store/selectors/tableDataSelectors.js";
import { getMarkedData } from "../../../redux-store/selectors/tableDataSelectors.js";
				...
				<tbody onMouseUp={isSelection.state ? handleStopHighlighting : null}>
					{
						Object.keys(data).map((item, rowNumber) => {
							const visibleData = Object.keys(data[item])
								.filter(key => identificationFields.hasOwnProperty(key))
